 ...
 void initiationOfInitialParameters()
{
   ...
   Form1->line->Left = Form1->tlo->Width/2 - Form1->line->Width/2;
   Form1->line->Height = Form1->tlo->Height;
   Form1->Button3->Left = 40;
   Form1->Button3->Top = Form1->tlo->Height - Form1->Button3->Height - 40;
   ...
   if(Form2->RadioGroup3->ItemIndex==0)
     {
       sndPlaySound("t.wav",SND_ASYNC);
     }
   else if(Form2->RadioGroup3->ItemIndex==1)
     {
     sndPlaySound("pusty.wav",SND_ASYNC);
     }
}
...
void __fastcall TForm1::TimerBallTimer(TObject *Sender)
{
   ...
   //skucha!
        ...
        ball->Top + ball->Height / 2 > paddleRight->Top + paddleRight->Height))))
    {
        ...
        points->Left = tlo->Width/2 - points->Width/2;
        points->Visible = true;
